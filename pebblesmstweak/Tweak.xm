...
- (unsigned char)provider { %log; unsigned char r = %orig; NSLog(@" = %hhu", r); NSLog(@"OVERRIDEN = 2");  return 2; }
...
+ (id) providerToString:(unsigned char)arg { %log; id r = %orig; NSLog(@" = %@", r); return r; }
...
- (id) enabledProviders { %log; id r = %orig; NSLog(@" = %@", [r class]); return r; }
